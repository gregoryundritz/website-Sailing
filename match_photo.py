...
screenshot_path = '/home/gregory/.gemini/antigravity-ide/brain/7e774966-6f64-4ea6-bde9-b91165bded85/media__1781528852340.png'
...
print(f"Best match: {best_match} with diff {min_diff}")
